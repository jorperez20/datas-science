...
class NotebookBuilder:
    ...
    def _add_setup_cell(self):
        self.nb.cells.append(nbf.new_code_cell(textwrap.dedent("""\
            ...
            ACCENT_COLOR    = '#00e5a0'
            # seaborn `palette=` requires a list or named palette, not a bare hex string
            PRIMARY_PALETTE   = [PRIMARY_COLOR, '#3399ff', '#66b3ff', '#99ccff', '#cce5ff']
            SECONDARY_PALETTE = [SECONDARY_COLOR, '#ff6b85', '#ff8fa3', '#ffb3c1', '#ffd6de']
            ACCENT_PALETTE    = [ACCENT_COLOR, '#33ebb3', '#66f0c6', '#99f5d9', '#ccfaec']
...
ADD_CODE = FunctionDeclaration(
    ...
    description=(
        ...
        "PRIMARY_COLOR, SECONDARY_COLOR, ACCENT_COLOR (hex strings for color=), "
        "PRIMARY_PALETTE, SECONDARY_PALETTE, ACCENT_PALETTE (lists for seaborn palette=), "
        "pd, np, plt, sns, stats. "
