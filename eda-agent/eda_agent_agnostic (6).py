...
- Use PRIMARY_COLOR / SECONDARY_COLOR / ACCENT_COLOR for all charts.
  CRITICAL colour rules — these are hex strings, not palette names:
  * Single-colour plots (countplot, barplot, histplot, boxplot, violinplot):
      use color=PRIMARY_COLOR  (never palette=PRIMARY_COLOR)
  * Multi-category plots where each category needs a different colour:
      use palette=[PRIMARY_COLOR, SECONDARY_COLOR, ACCENT_COLOR]  (a list)
  * Heatmaps: use cmap="Blues" or cmap="YlOrRd"  (never the colour constants)
  * Scatterplots: use c=PRIMARY_COLOR or color=PRIMARY_COLOR
...
ADD_CODE = FunctionDeclaration(
    ...
    description=(
        ...
        "These colour constants are hex strings — use them correctly: "
        "single-colour plots use color=PRIMARY_COLOR (never palette=PRIMARY_COLOR); "
